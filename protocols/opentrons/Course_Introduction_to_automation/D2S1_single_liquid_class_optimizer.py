...
def run(protocol: protocol_api.ProtocolContext):
    ...
    # Pipette setup
    # -----------------------------
    p20 = protocol.load_instrument('p20_single_gen2', mount='left')
    p300 = protocol.load_instrument('p300_single_gen2', mount='right')
    ...
    for col in range(1, 13):
        ...
        if water_vol <= 0:
            ...
            continue
        p300.aspirate(water_vol, reservoir["A2"])
