...
def run(ctx):
    ...
    # liquids
    if DILUTION_PREP_ON_DECK == 1:
        medium_def = ctx.define_liquid(name="MEDIUM", description="Bacterial culture medium (e.g., LB broth)", display_color="#704848")  ## Brown
        ...
        dilution_def = ctx.define_liquid(name="DILUTIONS", description="Serial 10-fold dilutions of each sample, per well", display_color="#00FFF2")  ## Light Blue
    ...
    else: p1k_1 = ctx.load_instrument('flex_1channel_1000', 'right')
